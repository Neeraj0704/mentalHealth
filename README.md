...
MindPath is an AI-powered mobile application designed to help individuals from underrepresented communities find mental health resources that are accessible, local, and relevant to their specific needs.

## The Problem

Access to mental health services is uneven. For many communities, barriers like language differences, lack of insurance, stigma, and limited awareness make it difficult to find appropriate support — even when services exist nearby.

## What MindPath Does

MindPath guides users through a simple, low-barrier experience:
...
MindPath is a resource navigation tool. It does not provide medical diagnoses, treatment plans, or clinical advice.
